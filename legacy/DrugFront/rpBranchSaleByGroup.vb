...
Public Class rpBranchSaleByGroup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpBranchSaleByGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpBranchSaleByGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpBranchSaleByGroup = New rpBranchSaleByGroup
        rpt.Site = Me.Site
        Return rpt
    End Function
